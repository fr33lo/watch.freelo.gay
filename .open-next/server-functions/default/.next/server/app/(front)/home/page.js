                    ...
                    children: [
                      'home',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 53450)),
                              'C:\\Users\\Michael\\Downloads\\watch.freelo.gay-dev\\watch.freelo.gay-dev\\src\\app\\(front)\\home\\page.tsx',
                            ],
                          },
                        ],
                      },
        ...
        async function n() {
          let a = `${h.C.name} Home`,
            b = [
              {
                title: 'Trending Now',
                req: { requestType: i.Y.TRENDING, mediaType: g.z.ALL },
                visible: !0,
              },
              {
                title: 'Netflix TV Shows',
                req: { requestType: i.Y.NETFLIX, mediaType: g.z.TV },
                visible: !0,
              },
              {
                title: 'Popular TV Shows',
                req: {
                  requestType: i.Y.TOP_RATED,
                  mediaType: g.z.TV,
                  genre: k.G.TV_MOVIE,
                },
                visible: !0,
