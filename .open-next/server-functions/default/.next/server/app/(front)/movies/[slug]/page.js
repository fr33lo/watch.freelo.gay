                          ...
                          '[slug]',
                          {
                            children: [
                              ...
                              {},
                              {
                                page: [
                                  () =>
                                    Promise.resolve().then(c.bind(c, 73034)),
                                  'C:\\Users\\Michael\\Downloads\\watch.freelo.gay-dev\\watch.freelo.gay-dev\\src\\app\\(front)\\movies\\[slug]\\page.tsx',
                                ],
                              },
                            ],
                          },
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      88428: (a, b, c) => {
        'use strict';
        (c.r(b), c.d(b, { default: () => n, revalidate: () => m }));
        var d = c(75338),
          e = c(83775),
          f = c(61851),
          g = c(85628),
        ...
        let m = 3600;
        async function n() {
          let a = `${g.C.name} Movie`,
            b = [
              {
                title: 'Trending Now',
                req: { requestType: i.Y.TRENDING, mediaType: l.z.MOVIE },
                visible: !0,
              },
              {
                title: 'Netflix Movies',
                req: { requestType: i.Y.NETFLIX, mediaType: l.z.MOVIE },
                visible: !0,
              },
              {
                title: 'Popular',
                req: { requestType: i.Y.POPULAR, mediaType: l.z.MOVIE },
                visible: !0,
              },
              {
                title: 'Comedy Movies',
                req: {
                  requestType: i.Y.GENRE,
                  mediaType: l.z.MOVIE,
                  genre: h.G.COMEDY,
                },
                visible: !0,
            ...
            c = await k.A.getShows(b),
            m = (0, j.jF)(c);
          return (0, d.jsxs)(d.Fragment, {
            children: [
              (0, d.jsx)('h1', { className: 'hidden', children: a }),
              (0, d.jsx)(e.default, { randomShow: m }),
