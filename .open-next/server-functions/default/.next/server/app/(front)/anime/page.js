(() => {
  ...
  ((a.id = 28),
    ...
    (a.modules = {
      ...
      8389: (a, b, c) => {
        'use strict';
        (c.r(b), c.d(b, { default: () => m, revalidate: () => l }));
        var d = c(75338),
          e = c(83775),
          f = c(61851),
          g = c(85628),
        ...
        let l = 3600;
        async function m() {
          let a = `${g.C.name} Anime`,
            b = [
              {
                title: 'Anime TV Shows Latest',
                req: { requestType: h.Y.ANIME_LATEST, mediaType: k.z.TV },
                visible: !0,
              },
              {
                title: 'Anime TV Shows Trending',
                req: { requestType: h.Y.ANIME_TRENDING, mediaType: k.z.TV },
                visible: !0,
              },
              {
                title: 'Anime TV Shows Top Rated',
                req: { requestType: h.Y.ANIME_TOP_RATED, mediaType: k.z.TV },
                visible: !0,
              },
              {
                title: 'Netflix Anime TV Shows',
                req: { requestType: h.Y.ANIME_NETFLIX, mediaType: k.z.TV },
                visible: !0,
              },
              {
                title: 'Anime Movies Latest',
                req: { requestType: h.Y.ANIME_LATEST, mediaType: k.z.MOVIE },
                visible: !0,
              },
              {
                title: 'Anime Movies Top Rated',
                req: { requestType: h.Y.ANIME_TOP_RATED, mediaType: k.z.MOVIE },
                visible: !0,
              },
            ],
            c = await j.A.getShows(b);
          c = c.map((a) => ({
            ...a,
            shows: a.shows.map((b) => ({
              ...b,
              media_type: a.title.includes('Movies') ? k.z.MOVIE : k.z.TV,
            })),
          }));
          let l = (0, i.jF)(c);
          return (0, d.jsxs)(d.Fragment, {
            children: [
              (0, d.jsx)('h1', { className: 'hidden', children: a }),
              (0, d.jsx)(e.default, { randomShow: l }),
              (0, d.jsx)(f.default, { shows: c }),
            ],
          });
        }
      },
      ...
      17017: (a, b, c) => {
        (Promise.resolve().then(c.bind(c, 83775)),
          Promise.resolve().then(c.bind(c, 61851)));
      },
      19121: (a) => {
        'use strict';
            ...
            children: [
              '',
              {
                children: [
                    ...
                    children: [
                      'anime',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 8389)),
                              'C:\\Users\\Michael\\Downloads\\watch.freelo.gay-dev\\watch.freelo.gay-dev\\src\\app\\(front)\\anime\\page.tsx',
                            ],
                          },
                        ],
                      },
                  ...
                  {
                    layout: [
                      () => Promise.resolve().then(c.bind(c, 63848)),
                      'C:\\Users\\Michael\\Downloads\\watch.freelo.gay-dev\\watch.freelo.gay-dev\\src\\app\\(front)\\layout.tsx',
                    ],
                    'not-found': [
                    ...
                    metadata: {
                      icon: [
                        async (a) =>
                          (
                            await Promise.resolve().then(c.bind(c, 70440))
                          ).default(a),
                      ],
                      apple: [],
                      openGraph: [],
              ...
              {
                layout: [
                  () => Promise.resolve().then(c.bind(c, 26171)),
                  'C:\\Users\\Michael\\Downloads\\watch.freelo.gay-dev\\watch.freelo.gay-dev\\src\\app\\layout.tsx',
                ],
                'global-error': [
                ...
                metadata: {
                  icon: [
                    async (a) =>
                      (await Promise.resolve().then(c.bind(c, 70440))).default(
                        a,
                      ),
                  ],
                  apple: [],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
              ...
              if (/\d/.test(a)) {
                if (/\d/.test(a)) {
                  ...
                  (a.includes('/tv-shows')
                    ...
                    .then((a) => {
                      let { data: b } = a;
                      i.K.setState({ show: b, open: !0, play: !0 });
                    })
                    .catch((a) => {
                      console.error('findMovie: ', a);
                    });
                }
              } else c.reset();
            }, [c]);
                  ...
                  (0, d.jsxs)(d.Fragment, {
                    children: [
                      (0, d.jsxs)('div', {
                        ...
                        children: [
                          (0, d.jsx)(p.A, {
                            src: `https://image.tmdb.org/t/p/original${a?.backdrop_path ?? a?.poster_path ?? ''}`,
                            alt: a?.title ?? 'poster',
                                ...
                                (0, d.jsxs)('div', {
                                  ...
                                  children: [
                                    (0, d.jsxs)('p', {
                                      ...
                                      children: [
                                        Math.round(a?.vote_average * 10) ?? '-',
                                        '% Match',
                                      ],
                                    }),
                                    (0, d.jsx)('p', {
                                      children: a?.release_date ?? '-',
                                    }),
                                  ],
                                }),
                                (0, d.jsx)('p', {
      ...
      45485: (a, b, c) => {
        ...
        var d = c(21124),
          ...
          n = c(75864);
        let o = ({ shows: a }) => {
          let b = (0, e.usePathname)(),
            c = (0, k.K)(),
            l = (0, f.j)(),
            o = m().useCallback(async () => {
              if (!/\d/.test(b) || c.open) return;
              let a = (0, g.Ht)(b);
              if (a)
                try {
                  let c = (
                    b.includes('/tv-shows')
                      ? await n.A.findTvSeries(a)
                      : await n.A.findMovie(a)
                  ).data;
                  c &&
                    k.K.setState({
                      show: c,
          ...
          l.query.length > 0)
            ? (0, d.jsx)(j.A, { shows: l.shows, query: l.query })
            : (0, d.jsxs)(d.Fragment, {
                children: [
                  c.open && (0, d.jsx)(h.A, {}),
                  a.map(
      ...
      53465: (a, b, c) => {
        (Promise.resolve().then(c.bind(c, 41041)),
          Promise.resolve().then(c.bind(c, 45485)));
      },
      55511: (a) => {
        'use strict';
      ...
      61851: (a, b, c) => {
        ...
        let d = (0, c(97954).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\Users\\\\Michael\\\\Downloads\\\\watch.freelo.gay-dev\\\\watch.freelo.gay-dev\\\\src\\\\components\\\\shows-container.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            );
          },
      ...
      83775: (a, b, c) => {
        ...
        let d = (0, c(97954).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\Users\\\\Michael\\\\Downloads\\\\watch.freelo.gay-dev\\\\watch.freelo.gay-dev\\\\src\\\\components\\\\hero.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            );
          },
  ...
  var c = b.X(
    0,
    [873, 892, 885, 428, 207, 301, 241, 612, 715, 487, 652, 842],
    () => b((b.s = 20306)),
  );
  module.exports = c;
})();
