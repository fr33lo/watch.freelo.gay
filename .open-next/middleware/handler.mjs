...
globalThis.openNextVersion = '3.8.1';
...
var NextConfig = {
  ...
  turbopack: {
    root: 'C:\\Users\\Michael\\Downloads\\watch.freelo.gay-dev\\watch.freelo.gay-dev',
  },
};
...
var RoutesManifest = {
  ...
  routes: {
    static: [
      ...
      {
        page: '/new-and-popular',
        regex: '^/new\\-and\\-popular(?:/)?$',
        routeKeys: {},
        namedRegex: '^/new\\-and\\-popular(?:/)?$',
      },
      {
        page: '/search',
        regex: '^/search(?:/)?$',
    ...
    dynamic: [
      ...
      },
      {
        ...
        namedRegex: '^/movies/(?<nxtPslug>[^/]+?)(?:/)?$',
      },
      {
        page: '/sitemap/[id]',
        regex: '^/sitemap/([^/]+?)(?:/)?$',
        routeKeys: { nxtPid: 'nxtPid' },
        namedRegex: '^/sitemap/(?<nxtPid>[^/]+?)(?:/)?$',
      },
      {
        page: '/tv-shows/[slug]',
        regex: '^/tv\\-shows/([^/]+?)(?:/)?$',
        routeKeys: { nxtPslug: 'nxtPslug' },
        namedRegex: '^/tv\\-shows/(?<nxtPslug>[^/]+?)(?:/)?$',
      },
      {
        page: '/watch/anime/[slug]',
        regex: '^/watch/anime/([^/]+?)(?:/)?$',
        routeKeys: { nxtPslug: 'nxtPslug' },
        namedRegex: '^/watch/anime/(?<nxtPslug>[^/]+?)(?:/)?$',
      },
      {
        page: '/watch/movie/[slug]',
        regex: '^/watch/movie/([^/]+?)(?:/)?$',
        routeKeys: { nxtPslug: 'nxtPslug' },
        namedRegex: '^/watch/movie/(?<nxtPslug>[^/]+?)(?:/)?$',
      },
      {
        page: '/watch/tv/[slug]',
        regex: '^/watch/tv/([^/]+?)(?:/)?$',
        routeKeys: { nxtPslug: 'nxtPslug' },
        namedRegex: '^/watch/tv/(?<nxtPslug>[^/]+?)(?:/)?$',
      },
    ],
    data: { static: [], dynamic: [] },
  },
...
var PrerenderManifest = {
  ...
  routes: {
    ...
    '/new-and-popular': {
      ...
      initialRevalidateSeconds: 3600,
      initialExpireSeconds: 31536e3,
      srcRoute: '/new-and-popular',
      dataRoute: '/new-and-popular.rsc',
      allowHeader: [
        'host',
        'x-matched-path',
        'x-prerender-revalidate',
  ...
  notFoundRoutes: [],
  preview: {
    previewModeId: '6fbf3a8e133e2cb2a396af7935720e1e',
    previewModeSigningKey:
      'ae8415272f0174de730befaf56dd848f68d3d6ab82cdb44d4fa60b6c721375fc',
    previewModeEncryptionKey:
      'a1180a902e5ec15aeb5d39d5837cc4ea17446afa4d60693a4c911ce0987de8ea',
  },
};
...
var AppPathRoutesManifest = {
  ...
  '/api/trpc/[trpc]/route': '/api/trpc/[trpc]',
  '/sitemap.xml/route': '/sitemap.xml',
  '/sitemap/[id]/route': '/sitemap/[id]',
  '/favicon.ico/route': '/favicon.ico',
  '/watch/anime/[slug]/page': '/watch/anime/[slug]',
  '/watch/movie/[slug]/page': '/watch/movie/[slug]',
  '/watch/tv/[slug]/page': '/watch/tv/[slug]',
  '/(front)/page': '/',
  '/(front)/anime/page': '/anime',
  '/(front)/movies/page': '/movies',
  '/(front)/home/page': '/home',
  '/(front)/new-and-popular/page': '/new-and-popular',
  '/(front)/tv-shows/[slug]/page': '/tv-shows/[slug]',
  '/(front)/search/page': '/search',
  '/(front)/movies/[slug]/page': '/movies/[slug]',
  '/(front)/tv-shows/page': '/tv-shows',
};
